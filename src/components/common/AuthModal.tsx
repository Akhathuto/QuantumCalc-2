              ...
              >
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    ...
                    <span className="relative z-10">{loading ? 'Authenticating...' : 'Sign in with Google'}</span>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-2 py-3 px-8 bg-transparent text-brand-text-secondary rounded-xl font-bold text-[11px] uppercase tracking-widest hover:text-brand-text hover:bg-brand-surface/20 transition-all border border-brand-border/40 disabled:opacity-50"
                  >
                    <span>Try Redirect Method</span>
                    <span className="opacity-50 text-[9px] font-normal lowercase">(Use if popup fails)</span>
                  </button>
                </div>
