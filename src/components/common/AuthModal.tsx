...
import { X, History, Cloud, ShieldCheck, ArrowRight } from 'lucide-react';
            ...
            <div className="p-10 md:p-14">
              ...
              >
                <button
                  ...
                  className="w-full relative overflow-hidden flex items-center justify-center gap-4 py-5 px-8 bg-white text-black rounded-2xl font-black text-[13px] uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_0_40px_rgba(255,255,255,0.1)] hover:shadow-[0_0_60px_rgba(255,255,255,0.2)] group"
                >
