                    ...
                    {activeTab === 'google' && (
                      ...
                      >
                        {window.self !== window.top && (
                          <div className="p-3 bg-brand-primary/10 rounded-xl border border-brand-primary/20 text-brand-text-secondary text-[10px] leading-relaxed space-y-2 text-center shadow-inner mb-2">
                            <div className="flex items-center gap-1.5 justify-center font-extrabold text-brand-primary uppercase tracking-widest text-[9.5px]">
                              <Shield size={14} className="text-brand-primary animate-pulse" />
                              <span>Sandbox Environment Notice</span>
                            </div>
                            <p className="opacity-90">
                              Browsers securely restrict cross-origin popup auth tokens within iframe contexts. If Google login fails, click below or use Guest/Email.
                            </p>
                            <div className="flex gap-2 justify-center pt-1">
                              <a 
                                ...
                                target="_blank" 
                                rel="noreferrer" 
                                className="inline-flex items-center justify-center gap-1 py-2 px-3 bg-brand-primary hover:bg-brand-primary/95 text-brand-bg rounded-xl text-[9px] font-black uppercase tracking-widest hover:-translate-y-0.5 transition-all shadow-md shadow-brand-primary/10"
                              >
                                🚀 Open in Full Tab
                              </a>
                              {signInSimulated && (
                                <button
                                  ...
                                  className="py-2 px-3 bg-brand-bg/50 hover:bg-brand-bg border border-brand-primary/20 hover:border-brand-primary/40 text-brand-primary rounded-lg text-[9px] font-black uppercase tracking-widest transition-all cursor-pointer hover:shadow-inner"
                                >
                                  ✨ Sandbox Bypass
                                </button>
                              )}
